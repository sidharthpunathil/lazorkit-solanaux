...
export function SwapInterface() {
  ...
  const handleGetQuote = async () => {
    if (network === "devnet") {
      alert("Jupiter API only works on Solana Mainnet, not Devnet. Please switch to Mainnet to use token swaps.");
      return;
    }
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-amber-700">
                Token swaps are only available on Solana Mainnet. Please switch to Mainnet using the network switcher in the top-right corner to use this feature.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="space-y-6">
        ...
        <div className="flex gap-3 pt-2">
          <button
            ...
            disabled={isDevnet || isFetchingQuote || !amount || parseFloat(amount) <= 0}
          ...
          <button
            onClick={handleSwap}
            disabled={isDevnet || isSwapping || !quote}
